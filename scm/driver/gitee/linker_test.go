...
func TestLink(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			sha:  "a7389057b0eb027e73b32a81e3c5923a71d01dde",
			want: "https://gitee.com/octocat/hello-world/merge_requests/42",
		},
		{
			path: "refs/tags/v1.0.0",
			want: "https://gitee.com/octocat/hello-world/-/tags/v1.0.0",
		},
		{
			path: "refs/heads/master",
...
func TestDiff(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			want:   "https://gitee.com/octocat/hello-world/merge_requests/12/diffs",
		},
	}
