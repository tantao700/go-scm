...
func encodePath(s string) string {
	// gitee documentation provides inconsistent example for whether '.' should be escaped:
	// https://docs.gitee.com/ee/api/README.html#file-path-branches-and-tags-name-encoding
	// https://docs.gitee.com/ee/api/repository_files.html#get-file-from-repository
