...
func TestContentFind(t *testing.T) {
	...
	gock.New("https://gitee.com").
		Get("/api/v5/repos/mirrors/diaspora/contents/app/models/key.rb").
...
func TestContentCreate(t *testing.T) {
	...
	gock.New("https://gitee.com").
		Post("/api/v5/repos/mirrors/diaspora/contents/app/project.rb").
		Reply(201).
		Type("application/json").
		SetHeaders(mockHeaders).
	...
	res, err := client.Contents.Create(context.Background(), "mirrors/diaspora", "app/project.rb", params)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestContentUpdate(t *testing.T) {
	...
	gock.New("https://gitee.com").
		Put("/api/v5/repos/mirrors/diaspora/contents/app/project.rb").
		Reply(200).
		Type("application/json").
		SetHeaders(mockHeaders).
	...
	res, err := client.Contents.Update(context.Background(), "mirrors/diaspora", "app/project.rb", params)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestContentList(t *testing.T) {
	...
	gock.New("https://gitee.com").
		Get("/api/v5/repos/gitee-org/gitee/repository/tree").
		MatchParam("path", "lib/gitee/ci").
