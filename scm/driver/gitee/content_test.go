...
func TestContentFind(t *testing.T) {
	...
	gock.New("https://gitee.com/api/v5").
		Get("/repos/tantao700/hello-world/contents/README").
...
func TestContentCreate(t *testing.T) {
	...
	gock.New("https://gitee.com/api/v5").
		Put("/repos/tantao700/hello-world/contents/test/hello").
		Reply(201).
		Type("application/json").
		SetHeaders(mockHeaders).
...
func TestContentDelete(t *testing.T) {
	...
	_, err := content.Delete(context.Background(), "tantao700/hello-world", "README", "master")
