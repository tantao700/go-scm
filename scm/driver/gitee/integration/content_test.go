...
func testContentFind(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		t.Parallel()
		result, _, err := client.Contents.Find(context.Background(), "gitee-org/testme", "VERSION", "5937ac0a7beb003549fc5fd26fc247adbce4a52e")
		if err != nil {
			t.Error(err)
			return
		}
...
func testContentFindBranch(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		t.Parallel()
		result, _, err := client.Contents.Find(context.Background(), "gitee-org/testme", "VERSION", "feature")
		if err != nil {
			t.Error(err)
			return
		}
