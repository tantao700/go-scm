...
func testBranchFind(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		t.Parallel()
		result, _, err := client.Git.FindBranch(context.Background(), "gitee-org/testme", "feature")
		if err != nil {
			t.Error(err)
			return
		}
...
func testBranchList(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		...
		result, _, err := client.Git.ListBranches(context.Background(), "gitee-org/testme", opts)
		if err != nil {
			t.Error(err)
			return
		}
...
func testTagFind(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		t.Parallel()
		result, _, err := client.Git.FindTag(context.Background(), "gitee-org/testme", "v1.1.0")
		if err != nil {
			t.Error(err)
			return
		}
...
func testTagList(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		t.Parallel()
		opts := scm.ListOptions{}
		result, _, err := client.Git.ListTags(context.Background(), "gitee-org/testme", opts)
		if err != nil {
			t.Error(err)
			return
		}
...
func testCommitFind(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		t.Parallel()
		result, _, err := client.Git.FindCommit(context.Background(), "gitee-org/testme", "0b4bc9a49b562e85de7cc9e834518ea6828729b9")
		if err != nil {
			t.Error(err)
			return
		}
...
func testCommitList(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		...
		result, _, err := client.Git.ListCommits(context.Background(), "gitee-org/testme", opts)
		if err != nil {
			t.Error(err)
			return
		}
