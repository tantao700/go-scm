...
func testBranchFind(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		t.Parallel()
		result, _, err := client.Git.FindBranch(context.Background(), "tantao700/hello-world", "master")
		if err != nil {
			t.Error(err)
			return
		}
...
func testBranchList(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		...
		result, _, err := client.Git.ListBranches(context.Background(), "tantao700/hello-world", opts)
		if err != nil {
			t.Error(err)
			return
		}
...
func testCommitFind(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		t.Parallel()
		result, _, err := client.Git.FindCommit(context.Background(), "tantao700/hello-world", "7fd1a60b01f91b314f59955a4e4d4e80d8edf11d")
		if err != nil {
			t.Error(err)
			return
		}
...
func testCommitList(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		...
		result, _, err := client.Git.ListCommits(context.Background(), "tantao700/hello-world", opts)
		if err != nil {
			t.Error(err)
			return
		}
