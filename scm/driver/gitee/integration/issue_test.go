...
func testIssueList(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		...
		result, _, err := client.Issues.List(context.Background(), "tantao700/hello-world", opts)
		if err != nil {
			t.Error(err)
		}
		if len(result) == 0 {
...
func testIssueFind(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		t.Parallel()
		result, _, err := client.Issues.Find(context.Background(), "tantao700/hello-world", 348)
		if err != nil {
			t.Error(err)
		}
...
func testIssueCommentList(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		...
		result, _, err := client.Issues.ListComments(context.Background(), "tantao700/hello-world", 348, opts)
		if err != nil {
			t.Error(err)
		}
		if len(result) == 0 {
...
func testIssueCommentFind(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		result, _, err := client.Issues.FindComment(context.Background(), "tantao700/hello-world", 348, 304068667)
		if err != nil {
			t.Error(err)
		}
...
func testIssue(issue *scm.Issue) func(t *testing.T) {
	return func(t *testing.T) {
		...
		if got, want := issue.Link, "https://github.com/tantao700/hello-world/issues/348"; got != want {
