...
func testIssueList(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		...
		result, _, err := client.Issues.List(context.Background(), "gitee-org/testme", opts)
		if err != nil {
			t.Error(err)
		}
		if len(result) == 0 {
...
func testIssueFind(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		t.Parallel()
		result, _, err := client.Issues.Find(context.Background(), "gitee-org/testme", 1)
		if err != nil {
			t.Error(err)
		}
...
func testIssueCommentList(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		...
		result, _, err := client.Issues.ListComments(context.Background(), "gitee-org/testme", 1, opts)
		if err != nil {
			t.Error(err)
		}
		if len(result) == 0 {
...
func testIssueCommentFind(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		result, _, err := client.Issues.FindComment(context.Background(), "gitee-org/testme", 1, 138083)
		if err != nil {
			t.Error(err)
		}
...
func testIssue(issue *scm.Issue) func(t *testing.T) {
	return func(t *testing.T) {
		...
		if got, want := issue.Link, "https://gitee.com/gitee-org/testme/-/issues/1"; got != want {
			t.Errorf("Want issue Title %q, got %q", want, got)
		}
...
func testIssueComment(comment *scm.Comment) func(t *testing.T) {
	return func(t *testing.T) {
		...
		if got, want := comment.Author.Avatar, "https://assets.gitee-static.net/uploads/-/system/user/avatar/1164/avatar.png"; got != want {
			t.Errorf("Want issue comment Author Name %q, got %q", want, got)
		}
