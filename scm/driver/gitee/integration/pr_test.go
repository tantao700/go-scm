...
func testPullRequestList(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		...
		result, _, err := client.PullRequests.List(context.Background(), "gitee-org/testme", opts)
		if err != nil {
			t.Error(err)
		}
		if len(result) == 0 {
...
func testPullRequestFind(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		t.Parallel()
		result, _, err := client.PullRequests.Find(context.Background(), "gitee-org/testme", 1)
		if err != nil {
			t.Error(err)
		}
...
func testPullRequestCommentFind(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		t.Parallel()
		result, _, err := client.PullRequests.FindComment(context.Background(), "gitee-org/testme", 1, 2990882)
		if err != nil {
			t.Error(err)
		}
...
func testPullRequestCommentList(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		...
		result, _, err := client.PullRequests.ListComments(context.Background(), "gitee-org/testme", 1, opts)
		if err != nil {
			t.Error(err)
		}
		if len(result) == 0 {
...
func testPullRequestChanges(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		t.Parallel()
		opts := scm.ListOptions{}
		result, _, err := client.PullRequests.ListChanges(context.Background(), "gitee-org/testme", 1, opts)
		if err != nil {
			t.Error(err)
		}
		if len(result) == 0 {
...
func testPullRequest(pr *scm.PullRequest) func(t *testing.T) {
	return func(t *testing.T) {
		...
		if got, want := pr.Link, "https://gitee.com/gitee-org/testme/-/merge_requests/1"; got != want {
		...
		if got, want := pr.Author.Avatar, "https://assets.gitee-static.net/uploads/-/system/user/avatar/13356/avatar.png"; got != want {
...
func testPullRequestComment(comment *scm.Comment) func(t *testing.T) {
	return func(t *testing.T) {
		...
		if got, want := comment.Author.Avatar, "https://assets.gitee-static.net/uploads/-/system/user/avatar/13356/avatar.png"; got != want {
