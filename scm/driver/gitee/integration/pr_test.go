...
func testPullRequestList(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		...
		result, _, err := client.PullRequests.List(context.Background(), "tantao700/hello-world", opts)
		if err != nil {
			t.Error(err)
		}
		if len(result) == 0 {
...
func testPullRequestFind(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		t.Parallel()
		result, _, err := client.PullRequests.Find(context.Background(), "tantao700/hello-world", 140)
		if err != nil {
			t.Error(err)
		}
...
func testPullRequestCommentFind(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		t.Parallel()
		result, _, err := client.PullRequests.FindComment(context.Background(), "tantao700/hello-world", 140, 60475333)
		if err != nil {
			t.Error(err)
		}
...
func testPullRequestCommentList(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		...
		result, _, err := client.PullRequests.ListComments(context.Background(), "tantao700/hello-world", 140, opts)
		if err != nil {
			t.Error(err)
		}
		if len(result) == 0 {
...
func testPullRequestChanges(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		t.Parallel()
		opts := scm.ListOptions{}
		result, _, err := client.PullRequests.ListChanges(context.Background(), "tantao700/hello-world", 140, opts)
		if err != nil {
			t.Error(err)
		}
		if len(result) == 0 {
...
func testPullRequest(pr *scm.PullRequest) func(t *testing.T) {
	return func(t *testing.T) {
		...
		if got, want := pr.Link, "https://github.com/tantao700/hello-world/pull/140.diff"; got != want {
