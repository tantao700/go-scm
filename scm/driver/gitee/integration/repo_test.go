...
func testRepoFind(client *scm.Client) func(t *testing.T) {
	return func(t *testing.T) {
		t.Parallel()
		result, _, err := client.Repositories.Find(context.Background(), "tantao700/hello-world")
		if err != nil {
			t.Error(err)
			return
		}
...
func testRepo(repository *scm.Repository) func(t *testing.T) {
	return func(t *testing.T) {
		...
		if got, want := repository.Clone, "https://github.com/tantao700/hello-world.git"; got != want {
			t.Errorf("Want repository Clone URL %q, got %q", want, got)
		}
		if got, want := repository.CloneSSH, "git@github.com:tantao700/hello-world.git"; got != want {
			t.Errorf("Want repository SSH URL %q, got %q", want, got)
		}
		if got, want := repository.Link, "https://github.com/tantao700/hello-world"; got != want {
