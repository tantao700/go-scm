...
func TestRepositoryFind(t *testing.T) {
	...
	gock.New("https://gitee.com/api/v5").
		Get("/repos/tantao700/hello-world").
		Reply(200).
	...
	client := NewDefault()
	got, res, err := client.Repositories.Find(context.Background(), "tantao700/hello-world")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestRepositoryPerms(t *testing.T) {
	...
	client := NewDefault()
	got, res, err := client.Repositories.FindPerms(context.Background(), "tantao700/hello-world")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestStatusList(t *testing.T) {
	...
	gock.New("https://gitee.com/api/v5").
		Get("/repos/tantao700/hello-world/statuses/6dcb09b5b57875f334f61aebed695e2e4193db5e").
		MatchParam("page", "1").
		MatchParam("per_page", "30").
		Reply(200).
		Type("application/json").
	...
	client := NewDefault()
	got, res, err := client.Repositories.ListStatus(context.Background(), "tantao700/hello-world", "6dcb09b5b57875f334f61aebed695e2e4193db5e", scm.ListOptions{Size: 30, Page: 1})
	if err != nil {
		t.Error(err)
		return
	}
...
func TestStatusCreate(t *testing.T) {
	...
	gock.New("https://gitee.com/api/v5").
		Post("/repos/tantao700/hello-world/statuses/6dcb09b5b57875f334f61aebed695e2e4193db5e").
		Reply(201).
		Type("application/json").
		SetHeaders(mockHeaders).
	...
	client := NewDefault()
	got, res, err := client.Repositories.CreateStatus(context.Background(), "tantao700/hello-world", "6dcb09b5b57875f334f61aebed695e2e4193db5e", in)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestDeployStatusCreate(t *testing.T) {
	...
	gock.New("https://gitee.com/api/v5").
		Post("/repos/tantao700/hello-world/deployments/1/status").
		Reply(201).
		Type("application/json").
		SetHeaders(mockHeaders).
	...
	client := NewDefault()
	got, res, err := client.Repositories.(*RepositoryService).CreateDeployStatus(context.Background(), "tantao700/hello-world", in)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestRepositoryHookFind(t *testing.T) {
	...
	gock.New("https://gitee.com/api/v5").
		Get("/repos/tantao700/hello-world/hooks/1").
		Reply(200).
		Type("application/json").
		SetHeaders(mockHeaders).
	...
	client := NewDefault()
	got, res, err := client.Repositories.FindHook(context.Background(), "tantao700/hello-world", "1")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestRepositoryHookList(t *testing.T) {
	...
	gock.New("https://gitee.com/api/v5").
		Get("/repos/tantao700/hello-world/hooks").
		MatchParam("page", "1").
		MatchParam("per_page", "30").
		Reply(200).
		Type("application/json").
	...
	client := NewDefault()
	got, res, err := client.Repositories.ListHooks(context.Background(), "tantao700/hello-world", scm.ListOptions{Page: 1, Size: 30})
	if err != nil {
		t.Error(err)
		return
	}
...
func TestRepositoryHookCreate(t *testing.T) {
	...
	gock.New("https://gitee.com/api/v5").
		Post("/repos/tantao700/hello-world/hooks").
		Reply(201).
		Type("application/json").
		SetHeaders(mockHeaders).
		File("testdata/hook.json")
	...
	client := NewDefault()
	got, res, err := client.Repositories.CreateHook(context.Background(), "tantao700/hello-world", in)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestRepositoryHookUpdate(t *testing.T) {
	...
	gock.New("https://gitee.com/api/v5").
		Patch("/repos/tantao700/hello-world/hooks/1").
		Reply(200).
		Type("application/json").
		SetHeaders(mockHeaders).
		File("testdata/hook.json")
	...
	client := NewDefault()
	got, res, err := client.Repositories.UpdateHook(context.Background(), "tantao700/hello-world", "1", in)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestRepositoryHookDelete(t *testing.T) {
	...
	gock.New("https://gitee.com/api/v5").
		Delete("/repos/tantao700/hello-world/hooks/1").
		Reply(204).
		Type("application/json").
		SetHeaders(mockHeaders)

	client := NewDefault()
	res, err := client.Repositories.DeleteHook(context.Background(), "tantao700/hello-world", "1")
	if err != nil {
		t.Error(err)
		return
	}
