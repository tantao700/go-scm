...
func TestRepositoryFind(t *testing.T) {
	...
	gock.New("https://gitee.com").
		Get("/api/v5/repos/mirrors/diaspora").
		Reply(200).
	...
	client := NewDefault()
	got, res, err := client.Repositories.Find(context.Background(), "mirrors/diaspora")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestSubgroupFind(t *testing.T) {
	...
	gock.New("https://gitee.com").
		Get("/api/v5/repos/gitee-org/gitter/gitter-demo-app").
		Reply(200).
		Type("application/json").
		SetHeaders(mockHeaders).
	...
	client := NewDefault()
	got, _, err := client.Repositories.Find(context.Background(), "gitee-org/gitter/gitter-demo-app")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestRepositoryPerms(t *testing.T) {
	...
	client := NewDefault()
	perms, res, err := client.Repositories.FindPerms(context.Background(), "mirrors/diaspora")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestStatusList(t *testing.T) {
	...
	gock.New("https://gitee.com").
		Get("/api/v5/repos/mirrors/diaspora/commits/6dcb09b5b57875f334f61aebed695e2e4193db5e/statuses").
		MatchParam("page", "1").
		MatchParam("per_page", "30").
		Reply(200).
		Type("application/json").
	...
	client := NewDefault()
	got, res, err := client.Repositories.ListStatus(context.Background(), "mirrors/diaspora", "6dcb09b5b57875f334f61aebed695e2e4193db5e", scm.ListOptions{Size: 30, Page: 1})
	if err != nil {
		t.Error(err)
		return
	}
...
func TestStatusCreate(t *testing.T) {
	...
	gock.New("https://gitee.com").
		Post("/api/v5/repos/mirrors/diaspora/statuses/6dcb09b5b57875f334f61aebed695e2e4193db5e").
		MatchParam("name", "continuous-integration/drone").
		MatchParam("state", "success").
		MatchParam("target_url", "https://ci.example.com/mirrors/diaspora/42").
		Reply(201).
		Type("application/json").
		SetHeaders(mockHeaders).
	...
	in := &scm.StatusInput{
		...
		Target: "https://ci.example.com/mirrors/diaspora/42",
	}

	client := NewDefault()
	got, res, err := client.Repositories.CreateStatus(context.Background(), "mirrors/diaspora", "6dcb09b5b57875f334f61aebed695e2e4193db5e", in)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestRepositoryHookFind(t *testing.T) {
	...
	gock.New("https://gitee.com").
		Get("/api/v5/repos/mirrors/diaspora/hooks/1").
		Reply(200).
		Type("application/json").
		SetHeaders(mockHeaders).
	...
	client := NewDefault()
	got, res, err := client.Repositories.FindHook(context.Background(), "mirrors/diaspora", "1")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestRepositoryHookList(t *testing.T) {
	...
	gock.New("https://gitee.com").
		Get("/api/v5/repos/mirrors/diaspora/hooks").
		MatchParam("page", "1").
		MatchParam("per_page", "30").
		Reply(200).
		Type("application/json").
	...
	client := NewDefault()
	got, res, err := client.Repositories.ListHooks(context.Background(), "mirrors/diaspora", scm.ListOptions{Page: 1, Size: 30})
	if err != nil {
		t.Error(err)
		return
	}
...
func TestRepositoryHookDelete(t *testing.T) {
	...
	gock.New("https://gitee.com").
		Delete("/api/v5/repos/mirrors/diaspora/hooks/1").
		Reply(204).
		Type("application/json").
		SetHeaders(mockHeaders)

	client := NewDefault()
	res, err := client.Repositories.DeleteHook(context.Background(), "mirrors/diaspora", "1")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestRepositoryHookCreate(t *testing.T) {
	...
	gock.New("https://gitee.com").
		Post("/api/v5/repos/mirrors/diaspora/hooks").
	...
	client := NewDefault()
	got, res, err := client.Repositories.CreateHook(context.Background(), "mirrors/diaspora", in)
	if err != nil {
		t.Error(err)
		return
	}
